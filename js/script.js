...
window.addEventListener('load', () => {
    ...
    const startApp = () => {
        ...
        if (typeof openWindow === 'function' && typeof splash2 !== 'undefined' && typeof nav2 !== 'undefined') {
...
class SnowflakeSystem {
    ...
    setupAudio() {
        this.audioElement = new Audio('sounds/clutch.mp3');
        this.audioElement.loop = true;
        this.audioElement.volume = 0.6;
        document.body.appendChild(this.audioElement);
        console.log('Audio element created:', this.audioElement.src);
        try {
